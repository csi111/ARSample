...
class InstantPlacementSettings {
    ...
    private var instantPlacementEnabled : Boolean? = true
    ...
    fun isInstantPlacementEnabled(): Boolean {
        return instantPlacementEnabled ?: false
    }
    ...
    fun setInstantPlacementEnabled(enable: Boolean) {
        ...
        editor.putBoolean(SHARED_PREFERENCES_INSTANT_PLACEMENT_ENABLED, instantPlacementEnabled ?: false)
        editor.apply()
    }
}